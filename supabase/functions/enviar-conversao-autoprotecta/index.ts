...
serve(async (req) => {
  ...
  try {
    ...
    if (queueItems && queueItems.length > 0) {
      ...
      // Encontra o próximo número ativo
      ...
      if (selectedItem) {
        ...
        // Atualiza posição para o próximo
        await supabase
          .from("whatsapp_queue_state")
    ...
    // Adiciona info de rotação aos dados
